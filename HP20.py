...
# "Experimental data"
# Assume the model is perfect, and the truth values of the coefficient is 1
truth = [1.]
...
data = np.loadtxt("data/AuAu200_RAA_cut15_coef1")
pT = data.T[0]
...
plt.savefig('result/data_RAA.pdf')
...
print(design)
data_1 = np.loadtxt("data/AuAu200_RAA_cut15_coef05")
data_2 = np.loadtxt("data/AuAu200_RAA_cut15_coef1")
data_3 = np.loadtxt("data/AuAu200_RAA_cut15_coef2")
data_4 = np.loadtxt("data/AuAu200_RAA_cut15_coef10")
model_data = []
...
plt.tight_layout(True)
plt.savefig("result/validation.pdf")
...
plt.xlim(ranges)
plt.savefig("result/corr-results.pdf")
...
plt.ylabel(r'$R_{AA}$', fontsize=15)
plt.legend()
plt.savefig("result/prediction.pdf")
