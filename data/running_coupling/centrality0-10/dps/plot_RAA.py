...
plt.errorbar(data_AA_x, RAA_upper_val, yerr=RAA_upper_err, label='$dt=0.05, t=50$')
plt.errorbar(data_AA_x, RAA_true_val, yerr=RAA_true_err, label='$dt=0.2, t=250$')
plt.errorbar(data_AA_x, RAA_lower_val, yerr=RAA_lower_err, label='$dt=0.2, t=50$')
...
# plt.title('$T^* > 0.35$')
plt.savefig('Tequila_0-10central_RAA_pion_range_new.pdf')
