...
data_3 = np.loadtxt("../../data/running_coupling/PbPb2760/centrality0-5/dps/RAA_true")
data_2 = np.loadtxt("../../data/running_coupling/AuAu200/centrality20-30/dps/RAA_true")
data_4 = np.loadtxt("../../data/running_coupling/PbPb2760/centrality30-40/dps/RAA_true")
output_1 = data_1.T[1]
output_2 = data_2.T[1]
output_3 = data_3.T[1]
