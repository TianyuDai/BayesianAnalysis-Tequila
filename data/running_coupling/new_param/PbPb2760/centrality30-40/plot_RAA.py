...
plt.errorbar(data_RAA_x, data_RAA_val, xerr=data_RAA_xerr, yerr=data_RAA_err, fmt='.', label='PHENIX 2013', color='red')


# AA_upper = np.loadtxt("PbPb2760_pion_Q01.6.txt")
# AA_true = np.loadtxt("PbPb2760_pion_Q02.2.txt")
...
# plt.errorbar(AA_x, RAA_true_val, yerr=RAA_true_err, label='validate')
...
plt.ylim(0, 1.8)
plt.xlim(10, 120)
plt.title('Tequile, Pb+Pb 2760GeV, 30-40% centrality, $(\Pi^+ + \Pi^-)/2$')
# plt.title('$T^* > 0.35$')
plt.savefig('Tequila_30-40central_RAA_pion_dp20-29.pdf')
